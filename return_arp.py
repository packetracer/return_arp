...
user = <ANSIBLE USER ACCOUNT GOES HERE>
pwd = <ANSIBLE USER ACCOUNT PASSWORD GOES HERE>
...
def executeCmd(host):
        cmd = """ansible-playbook /ansible/plays/show_cmd2.yml --limit '"""+host+"""' -e 'user="{0}" pass="{1}" cmd="{2}"' |  sed 's/\\\\n/\\n/g'""".format(user,pwd,webCmd)
